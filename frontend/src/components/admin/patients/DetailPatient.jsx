...
export default function DetailPatient() {
  ...
  return (
    <div className="min-w-screen relative flex flex-col items-center justify-between p-10 align-middle font-poppins lg:py-16 lg:pl-72 lg:pr-12">
      ...
      <div className="mb-2 h-12 w-full items-center ">
        <h2 className="mb-2 text-center text-2xl font-semibold lg:mb-8 lg:text-4xl">
          {patient.firstname} {patient.lastname}
        </h2>
        <form className="grid grid-cols-1 content-center lg:mt-8 lg:gap-8  ">
          <div className="flex flex-col lg:flex-row ">
            <div className="text-base font-bold">Nom</div>
            <div className="rounded-lg p-2 text-base font-medium lg:h-14">
              {patient.lastname}
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              value={patient.address_streetname}
              className="mb-2 rounded-lg p-2 text-base font-medium lg:h-14"
              border="none"
            />
          </div>
