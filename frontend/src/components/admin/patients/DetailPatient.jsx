...
export default function DetailPatient() {
  ...
  return (
    <div className="min-w-screen relative flex flex-col items-center justify-between p-10 align-middle font-poppins lg:py-16 lg:pl-72 lg:pr-12">
      <div className="flex w-full items-center ">
        <h3 className="mb-2 text-2xl font-semibold lg:mb-8 lg:text-4xl">
          Fiche patient
        </h3>
      </div>
      <div className="mb-2 w-full lg:mt-8 lg:w-fit lg:gap-8 lg:rounded-xl lg:bg-gray-200 lg:p-8 lg:shadow-xl">
        <h2 className="mb-8 mt-4 text-center text-xl font-semibold lg:mb-8 lg:text-4xl">
          {patient.firstname} {patient.lastname}
        </h2>

        <div className="flex">
          <div className="mb-2 text-xs font-semibold lg:text-base ">Nom :</div>
          <div className="mb-2 pl-2 text-xs font-medium lg:h-14 lg:text-base">
            {patient.lastname}
          </div>
        </div>
        <div className="flex">
          <div className="mb-2 text-xs font-semibold lg:text-base">
            Prénom :
          </div>
          <div className="mb-2 pl-2 text-xs font-medium lg:h-14 lg:text-base ">
            {patient.firstname}
        ...
        <div className="flex">
          <div className="mb-2 text-xs font-semibold lg:text-base">Ville :</div>
          <div className="mb-2 pl-2 text-xs font-medium lg:h-14 lg:text-base">
            {patient.city}
          </div>
        </div>
        ...
        <div className="flex">
          <div className="mb-2 text-xs font-semibold lg:text-base">Email :</div>
          <div className="mb-2 pl-2 text-xs font-medium lg:h-14 lg:text-base">
            {patient.email}
          </div>
        </div>
