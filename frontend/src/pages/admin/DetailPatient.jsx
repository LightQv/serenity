...
export default function DetailPatient() {
  ...
  return (
    <div className="min-w-screen relative flex flex-col items-center justify-between p-10 align-middle font-poppins lg:py-16 lg:pl-72 lg:pr-12">
      ...
      <div className="mb-2 w-fit lg:mt-8 lg:rounded-xl lg:bg-gray-200 lg:p-8 lg:shadow-xl">
        <div className="lg:flex lg:justify-between">
          <h2 className="mb-2 mt-4 text-2xl font-bold lg:mb-8 lg:text-4xl ">
            {patient.firstname} {patient.lastname}
          </h2>
          <div className="mb-2 mt-3 flex flex-row gap-4">
            <button
              type="button"
