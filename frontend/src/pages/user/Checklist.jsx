...
export default function Checklist() {
  ...
  const [activeHeading, setActiveHeading] = useState(headings[2].name);
  const [content, setContent] = useState(headings[2].label);
  const [activeColor, setActiveColor] = useState(headings[2].color);
